...
const ValidasiLinkDashboardKepalaDinas = ({ idSurat }) => {
  ...
  return (
    <Link className="flex w-fit items-center gap-2 text-base font-semibold text-brand-500" to="/detail-validasi-kepala" onClick={() => handleCekClick()}>
...
export default ValidasiLinkDashboardKepalaDinas;
