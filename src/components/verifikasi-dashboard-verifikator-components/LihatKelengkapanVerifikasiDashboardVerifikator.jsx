...
const LihatKelengkapanVerifikasiDashboardVerifikator = ({ id_surat }) => {
  ...
  return (
    <Link className="flex w-fit items-center gap-2 text-base font-semibold text-brand-500" to="/kelengkapan-dokumen-verifikator" onClick={() => handleCekClick(id_surat)}>
...
export default LihatKelengkapanVerifikasiDashboardVerifikator;
