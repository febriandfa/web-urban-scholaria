...
const ValidasiRiwayatDashboardUser = ({ isPropose }) => {
  ...
  const filteredPengajuan = pengajuan?.filter((item) => item?.status === "Validasi Kepala Dinas" || item?.status === "Pengeluaran Surat");
...
export default ValidasiRiwayatDashboardUser;
