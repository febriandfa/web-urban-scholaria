...
const SurveyRiwayatDashboardUser = ({ isPropose }) => {
  ...
  const filteredPengajuan = pengajuan?.filter((item) => item?.status === "Penjadwalan Survey" || item?.status === "Verifikasi Hasil Survey");
...
export default SurveyRiwayatDashboardUser;
