...
const CariDataPerizinan = () => {
  return (
    <form>
      <div className="relative">
        <input className="w-full pl-3 pr-10 h-9 rounded-lg text-sm border border-neutral-400" type="text" placeholder="Cari Perizinan..." />
        <svg className="absolute right-3 top-1.5" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
          <path
...
export default CariDataPerizinan;
