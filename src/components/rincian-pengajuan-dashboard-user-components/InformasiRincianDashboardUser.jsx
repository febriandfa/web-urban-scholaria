...
const InformasiRincianDashboardUser = () => {
  return (
    <div>
      <div className="flex items-center mb-4">
        <h1 className="text-lg text-brand-500 font-semibold">Perizinan Pembangunan TK</h1>
        <p className="text-sm font-semibold ml-auto">ID Pengajuan: URSBY1234567891</p>
