  ...
  return (
    <div>
      ...
      <div className="flex gap-5 mb-4">
        ...
        {(statusSurat === "Selesai" || statusSurat === "Ditolak") && (
      ...
      {statusSurat === "Selesai" ? null : (
        <a className="flex items-center justify-center gap-3 py-2 px-4 bg-brand-500 w-full rounded-lg text-base font-semibold text-white" href={`https://urbanscholaria.my.id/api/surat/` + idSurat + `/cetak-kwitansi`} target="_blank">
