...
const InputPasswordAuthPage = ({ name, label, placeholder, value, onChange, required }) => {
  ...
  return (
    <div className="mb-6">
      <label className="block mb-1 font-semibold text-sm text-brand-500" htmlFor={name}>
        {label}
      ...
      <div className="relative">
        ...
        />
        <div className="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" onClick={handlePassVisible}>
          {passVisible ? (
            <svg className="w-5 h-5 fill-current text-neutral-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default InputPasswordAuthPage;
