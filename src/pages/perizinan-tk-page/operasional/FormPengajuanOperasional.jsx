...
const FormPerizinanBody = ({ inputValue, onInputChange, selectedFiles, onFileInputChange }) => {
  ...
  return (
    <div>
      ...
      <form className="w-4/5 mx-auto" action="post" method="post">
        ...
        <button onClick={toggleInputSection} className={`py-2 px-4 text-center cursor-pointer bg-brand-200 w-full rounded-lg text-base font-semibold text-neutral-800 block ${showInputSection ? "block" : "hidden"}`}>
          Selanjutnya
        </button>
