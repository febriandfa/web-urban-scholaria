    ...
    <>
      ...
      <div className="grid grid-cols-5 gap-20">
        <div className="col-span-3">
          <DeskripsiPerizinan
            desc="Urban Scholaria merangkul pengajuan perizinan bangunan, operasional, dan perubahan operasional untuk jenjang Taman Kanak-Kanak, Sekolah Dasar, Sekolah Menengah Pertama, Sekolah Menengah Akhir dengan fokus pada menciptakan lingkungan belajar yang terstruktur, aman, dan mendukung pertumbuhan optimal anak-anak. Dengan formulir pengajuan yang terintegrasi dan panduan yang jelas, aplikasi ini mempermudah proses administratif untuk memastikan fasilitas TK, SD, SMP, SMA sesuai dengan standar peraturan pendidikan."
        ...
        <div className="col-span-2">
          <InformasiTambahan linkAlur="#" linkSyarat={link} />
          {isLoggedIn && (
